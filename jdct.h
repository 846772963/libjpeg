...
#define jpeg_fdct_islow_mirror	jFDislowmirror

#define jpeg_fdct_ifast		    jFDifast
#define jpeg_fdct_ifast_mirror	jFDifastmirror
...
EXTERN(void) jpeg_fdct_islow_mirror
    JPP((DCTELEM * data, JSAMPARRAY sample_data, JDIMENSION start_col));

EXTERN(void) jpeg_fdct_ifast_mirror
    JPP((DCTELEM * data, JSAMPARRAY sample_data, JDIMENSION start_col));
